      ...
      <!-- <div class="left-tree">
                ...
                <div class="select-opt">
                    <div class="open" @click="openAll">
                        ...
                        <span>{{ listReactive.isExpand ? "收缩" : "展开" }}所有</span>
                    </div>
                </div>
        ...
        <div class="search-box">
          <div class="condition">
            ...
            <div class="condition-key">
              <span class="search-text">指标状态：</span>
            ...
            <div class="condition-key">
              <span class="search-text">流程状态：</span>
    ...
    <n-drawer v-model:show="highFind.showScreen" :width="450">
      <n-drawer-content closable>
        ...
        <div class="find-content">
          <div class="find-item">
            <span class="find-text">注册时间：</span>
            <n-date-picker
              class="find-ipt"
          ...
          <div class="find-item">
            <span class="find-text">指标类型：</span>
            <n-select
              class="find-ipt"
              clearable
        ...
        <template #footer>
          <n-button type="info" @click="findIndexList">查询</n-button>
        </template>
      </n-drawer-content>
    </n-drawer>
    ...
    >
      <div class="version-box">
        ...
        <div class="version-food">
          <div class="cancel" @click="versionReactive.showVersion = false">取消</div>
          <div class="start" @click="confirmVersion">启用</div>
        </div>
      </div>
    </n-modal>
...
const versionReactive = reactive({
  ...
  versionData: [
    ...
    { key: 3, code: "GDL_23", name: "营销服务3", type: "测试44", version: "1.0" },
    { key: 4, code: "GDL_23", name: "营销服务3", type: "测试44", version: "1.0" },
    { key: 5, code: "GDL_23", name: "营销服务3", type: "测试44", version: "1.0" },
  ],
  versionColumns: [
    ...
    { title: "指标编码", key: "code", align: "center" },
    {
      title: "指标名称",
      key: "name",
      align: "center",
...
const listReactive = reactive({
  ...
  enums: {
    ...
    flowInsState: [
      ...
      { label: "处理中", value: 1 },
      { label: "处理完成", value: 2 },
      { label: "不同意（返回首节点）", value: 3 },
      { label: "返回上一步", value: 4 },
    ],
    status:[{label:'全部',value:''},{label:'草稿',value:'2'},{label:'上线',value:'1'},{label:'下线',value:'0'}],
  },
  tableShow: true,
  ...
  tableColumns: [
    { title: "指标编码", key: "gdlCode", ellipsis: true, isChecked: true, width: 180 },
    { title: "指标名称", key: "gdlName", ellipsis: true, isChecked: true, width: 180 },
    {
      title: "指标类型",
      key: "gdlType",
      align: "center",
    ...
    { title: "指标体系", key: "dirName", align: "center", isChecked: true, width: 180 },
    {
      title: "指标周期",
      key: "gdlCycleName",
      ellipsis: { title: true },
    ...
    // { title: '版本', key: 'version', align: "center" },
    {
      ...
      render(rowData: any) {
        return h(
          ...
          {
            default: () =>
              rowData.gdlStatus == 1 ? "上线" : rowData.gdlStatus == 2 ? "草稿" : "下线",
          }
        );
      },
    },
    ...
    { title: "创建人", key: "crtUserName", ellipsis: true, isChecked: false, width: 180 },

    { title: "创建时间", key: "crtDt", ellipsis: true, isChecked: false, width: 160 },
    {
      title: "修改人",
      key: "modifyUserName",
      ellipsis: true,
    ...
    { title: "修改时间", key: "modifyDt", ellipsis: true, isChecked: false, width: 160 },
  ],
  operateColumns: [],
  showColumns: [],
  tableData: [],
...
const init = () => {
  ...
  let powerList = [];
  if (findAtom != -1) powerList.push({ label: "注册原子指标", key: "atom" });
  if (findComputed != -1) powerList.push({ label: "新建派生指标", key: "computed" });
...
const initTableColimns = function () {
  ...
  findDelete != -1 && dropDownActions.push({ label: "删除", key: "del" });
      ...
      "div",
      {
        ...
        onClick: () => {
          if (column.key == "version") {
            ...
            console.log("点击了版本", rowData);
          } else {
            console.log("点击了指标名称", rowData);
          }
        },
      },
