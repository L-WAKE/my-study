module.exports = {
  dark: {
    ...
    divideLineColor: "#f1f1f1" /* 分割线颜色 */,
    moreLinkColor: "#007dc8" /* 更多、编辑、删除等纯文字链接颜色 */,
    homeChartColor: " #0071c4" /* 首页图表框标题 */,
    ...
    menuTagBgImg: "$darkTabActiveBg",
    menuTagHoverBgImg: "$darkHoverBg",
