              ...
              this.$common.requireBackData({
                  ...
                  successCallBack: (response) => {
                      if (response.status == 200) {
                          ...
                          this.$message.error(_this.$t('i18n889'));
                      }
                  }
              });
          },
              ...
              this.$common.requireBackData({
                  ...
                  successCallBack: (response) => {
                      if (response.status == 200 && response.data.status==1) {
                          ...
                          this.$message.error(`${_this.$t('i18n891')}API${_this.$t('i18n892')}`);
                      }
              ...
              this.$common.requireBackData({
                  ...
                  successCallBack: (response) => {
                      if (response.status == 200 && response.data.status==1) {
                          ...
                          this.$message.error(_this.$t('i18n894'));
                      }
                  }
              });
          },
              ...
              this.$common.requireBackData({
                  ...
                  successCallBack: (response) => {
                      if (response.status == 200 && response.data.status==1) {
                          ...
                          this.$message.error(_this.$t('i18n895'));
                      }
                      this.publicListLoading = false;
                  }
              });
          ...
          saveApi(autoPub){
            let _this = this
              ...
              if(!_param.api_name.trim()){
                  setTimeout(()=>{this.$message.error(_this.$t('i18n897'));},10)
                  setTimeout(()=>{this.$message({showClose: true,message: _this.$t('i18n897'),type: 'error'}),10});
                  setTimeout(()=>{this.$message({showClose: true,message: _this.$t('i18n897'));},10, type: 'error' });
                  _status = false;
              }
              if((_param.api_name.trim()).length>64){
                  setTimeout(()=>{this.$message.error(_this.$t('i18n898'));},10)
                  _status = false;
              }
              if(!_param.api_url){
                  setTimeout(()=>{this.$message.error(`${_this.$t('i18n867')}url${_this.$t('i18n899')}`);},20)
                  _status = false;
              }
              if(_param.biser_source_id=='null'){
                  setTimeout(()=>{this.$message.error(_this.$t('i18n900'));},30)
                  _status = false;
              }
              if(!_status){
                  this.isSave = false;
                  ...
                  this.$common.requireBackData({
                      ...
                      successCallBack: (response) => {
                          if (response.status == 200 && response.data.status==1) {
                              ...
                              this.$message.error(_this.$t('i18n903'));
                          }
                      }
                  });
              }).catch(() => {});
              ...
              this.$common.requireBackData({
                  ...
                  successCallBack: (response) => {
                      if (response.status == 200) {
                          ...
                          this.$message.error(_this.$t('i18n909'));
                      }
                  }
              });
          },
